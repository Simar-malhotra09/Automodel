...
Nemotron 3.5 Super VL (`nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16`, architecture
...
The **model before task-specific fine-tuning** answers such a question with a paragraph of reasoning
that might not end in a query. After fine-tuning, it outputs **exactly one SQL query** against the schema it is given.
...
model:
  ...
  pretrained_model_name_or_path: nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16
...
BASE = "nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16"
...
|---|---|---|---|---|
| Before fine-tuning (`NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16`) | 0/20 | 0.140 | 0.141 | 0/20 |
