...
The **model before task-specific fine-tuning** produces free-form descriptions. After fine-tuning, it outputs
...
Pointing `CKPT` at the BF16 checkpoint ID (`nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16`)
scores the model before task-specific fine-tuning the same way.
...
|---|---|---|---|
| Before fine-tuning (`NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16`) | 0/20 | 0.048 | 0/20 (free-form description of the photo) |
